...
object DummyData {
    ...
    fun generateSeries(): List<TvEntity> {
    ...
    fun generateMovieWatchlist(movies: List<MovieEntity>): List<MovieEntity> {
        val watchlist = ArrayList<MovieEntity>()
        for (movie in movies) {
    ...
    fun generateTvWatchlist(tvShows: List<TvEntity>): List<TvEntity> {
        val watchlist = ArrayList<TvEntity>()
        for (tv in tvShows) {
            tv.isFavorite = true
            watchlist.add(tv)
        }
